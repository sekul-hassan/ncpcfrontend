...
const publicationNameList=["Prof. Dr. Md Abul Kalam Azad", "Nadia Afrin Ritu", "Sabrina Sharmin", "Samsun Nahar Khandakar"]
const publicationPostList=["Convenor", "Coordinator", "Member", "Member"]
